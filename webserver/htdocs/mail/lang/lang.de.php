...
$lang['user']['fetch_mail'] = 'Externe E-Mails abrufen';
$lang['user']['fetch_mail_description'] = 'Dies ist <b>keine</b> wiederkehrende Aufgabe. Dieses Feature erlaubt Ihnen, das einmalige Abrufen von Nachrichten von einem IMAP-Mailserver. Es werden beidseitig keine Nachrichten gelöscht.<br /><br />
	Die erste Synchronisation kann eine Weile in Anspruch nehmen.<br /><br />
	Die IDs der abgerufenen Nachrichten werden gespeichert und bei der nächsten Synchronisation übersprungen. Sie können dieses Verhalten deaktivieren, indem Sie den Haken <i>"Bereits abgerufene Nachrichten noch einmal abrufen"</i> setzen.';
$lang['user']['fetch_mail_hostname'] = 'IMAP-Hostname:';
$lang['user']['fetch_mail_port'] = 'IMAP-Port:';
$lang['user']['fetch_mail_username'] = 'IMAP-Benutzername:';
$lang['user']['fetch_mail_password'] = 'IMAP-Passwort:';
$lang['user']['fetch_mail_no_encryption'] = 'Keine Verschlüsselung';
$lang['user']['fetch_mail_folder_selection'] = 'Auswahl von Quell- und Ziel-Ordnern';
$lang['user']['fetch_mail_source'] = 'Quell-Server';
$lang['user']['fetch_mail_source_folder'] = 'Quell-Ordner';
$lang['user']['fetch_mail_target'] = 'Ziel-Ordner';
$lang['user']['fetch_mail_read_folders'] = 'Abrufen';
$lang['user']['fetch_mail_read_folders_hint'] = 'Bitte füllen Sie die Quell-Server Daten aus und klicken Sie links auf "Abrufen".';
$lang['user']['fetch_mail_repull'] = 'Bereits abgerufene Nachrichten noch einmal abrufen';
$lang['user']['fetch_mail_start'] = 'Vorgang starten';
$lang['user']['fetch_mail_status'] = 'Vorgangsstatus:';
...
$lang['start']['kb_hint'] = 'Eine Anleitung zur Software-Konfiguration finden Sie auf XYZ.';
...
$lang['edit']['dkim_record_info'] = '<small>Bitte hinterlegen Sie einen TXT-Record mit obigem Wert in den DNS-Einstellungen Ihrer Domainverwaltung.';
...
$lang['admin']['reject_unknown_client_hostname'] = 'Ablehnen, wenn Reverse-DNS Eintrag fehlt oder falsch ist und/oder der Name nicht zur verbindenden IP auflöst ("exact PTR match check") <b>(reject_unknown_client_hostname)</b>';
$lang['admin']['reject_non_fqdn_helo_hostname'] = 'Ablehnen, wenn der HELO Hostname kein FQDN ist <b>(reject_non_fqdn_helo_hostname)</b>';
$lang['admin']['z1_greylisting'] = 'Greylisting für unbekannte Sender verwenden';
