...
$lang['user']['fetch_mail'] = 'Fetch messages';
$lang['user']['fetch_mail_description'] = 'This is <b>not</b> a recurring task. This feature allows you to fetch messages from a remote IMAP server. No messages will be deleted on both sides.<br /><br />
	The first synchronization may take a while.<br /><br />
	IDs of fetched messages will be saved and skipped the next time you use this feature. You can remove old IDs by checking <i>"Do not skip previously fetched messages"</i>.';
$lang['user']['fetch_mail_hostname'] = 'IMAP hostname:';
$lang['user']['fetch_mail_port'] = 'IMAP port:';
$lang['user']['fetch_mail_username'] = 'IMAP username:';
$lang['user']['fetch_mail_password'] = 'IMAP password:';
$lang['user']['fetch_mail_no_encryption'] = 'No encryption';
$lang['user']['fetch_mail_folder_selection'] = 'Select source and destination folders';
$lang['user']['fetch_mail_source'] = 'Source server';
$lang['user']['fetch_mail_source_folder'] = 'Source folder';
$lang['user']['fetch_mail_target'] = 'Target folder';
$lang['user']['fetch_mail_read_folders'] = 'Read folders';
$lang['user']['fetch_mail_read_folders_hint'] = 'Please fill in all required source server data and click "Read folders".';
$lang['user']['fetch_mail_repull'] = 'Do not skip previously fetched messages';
$lang['user']['fetch_mail_start'] = 'Start process';
$lang['user']['fetch_mail_status'] = 'Process status:';
...
$lang['delete']['remove_alias_warning'] = '<b>Warning:</b> You are about the alias address <b>%s</b>!';
...
$lang['edit']['dkim_record_info'] = '<small>Please add a TXT record with the given value to your DNS settings.';
...
$lang['admin']['reject_unknown_client_hostname'] = 'Reject when the client IP address has no address -> name mapping and/or returned name does not match the IP (exact PTR match check) <b>(reject_unknown_client_hostname)</b>';
$lang['admin']['reject_non_fqdn_helo_hostname'] = 'Reject when HELO hostname is not a FQDN <b>(reject_non_fqdn_helo_hostname)</b>';
$lang['admin']['z1_greylisting'] = 'Use greylisting for unauthenticated, unknown and not whitelisted senders';
